...
void PIDPositionController::initialize_ros()
{
    ...
    // ROS subscribers
    airsim_odom_sub_ = nh_.subscribe("/vins_fusion/imu_propagate", 50, &PIDPositionController::airsim_odom_cb, this);
...
void PIDPositionController::airsim_odom_cb(const nav_msgs::Odometry::ConstPtr &odom_msg)
{
    has_odom_ = true;
