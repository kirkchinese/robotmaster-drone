...
if("TRUE" STREQUAL "TRUE")
  set(drone_detect_SOURCE_PREFIX /home/misaka/drone/yy_last/robo_commit/src/planner/drone_detect)
  set(drone_detect_DEVEL_PREFIX /home/misaka/drone/yy_last/robo_commit/devel)
  ...
  set(drone_detect_INSTALL_PREFIX /home/misaka/drone/yy_last/robo_commit/install)
...
if(NOT "/home/misaka/drone/yy_last/robo_commit/src/planner/drone_detect/include;/usr/include/eigen3;/usr/include/opencv4;/usr/include " STREQUAL " ")
  set(drone_detect_INCLUDE_DIRS "")
  set(_include_dirs "/home/misaka/drone/yy_last/robo_commit/src/planner/drone_detect/include;/usr/include/eigen3;/usr/include/opencv4;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'drone_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/misaka/drone/yy_last/robo_commit/src/planner/drone_detect/${idir}'.  ${_report}")
    endif()
