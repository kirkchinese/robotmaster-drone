...
if("TRUE" STREQUAL "TRUE")
  set(plan_env_SOURCE_PREFIX /home/misaka/drone/yy_last/robo_commit/src/planner/plan_env)
  set(plan_env_DEVEL_PREFIX /home/misaka/drone/yy_last/robo_commit/devel)
  set(plan_env_INSTALL_PREFIX "")
  set(plan_env_PREFIX ${plan_env_DEVEL_PREFIX})
else()
  set(plan_env_SOURCE_PREFIX "")
  set(plan_env_DEVEL_PREFIX "")
  set(plan_env_INSTALL_PREFIX /home/misaka/drone/yy_last/robo_commit/install)
...
if(NOT "/home/misaka/drone/yy_last/robo_commit/src/planner/plan_env/include;/usr/include/opencv4 " STREQUAL " ")
  set(plan_env_INCLUDE_DIRS "")
  set(_include_dirs "/home/misaka/drone/yy_last/robo_commit/src/planner/plan_env/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plan_env' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/misaka/drone/yy_last/robo_commit/src/planner/plan_env/${idir}'.  ${_report}")
    endif()
