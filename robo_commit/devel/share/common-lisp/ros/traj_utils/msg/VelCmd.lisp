...
(cl:defmethod cl:initialize-instance :after ((m <VelCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-msg:<VelCmd> is deprecated: use traj_utils-msg:VelCmd instead.")))

(cl:ensure-generic-function 'twist-val :lambda-list '(m))
(cl:defmethod twist-val ((m <VelCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-msg:twist-val is deprecated.  Use traj_utils-msg:twist instead.")
  (twist m))
