...
(cl:defmethod cl:initialize-instance :after ((m <TreePoses>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TreePoses)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-msg:<TreePoses> is deprecated: use traj_utils-msg:TreePoses instead.")))
