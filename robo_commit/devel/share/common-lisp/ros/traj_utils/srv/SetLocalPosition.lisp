...
(cl:defmethod cl:initialize-instance :after ((m <SetLocalPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLocalPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<SetLocalPosition-request> is deprecated: use traj_utils-srv:SetLocalPosition-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <SetLocalPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:x-val is deprecated.  Use traj_utils-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <SetLocalPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:y-val is deprecated.  Use traj_utils-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <SetLocalPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:z-val is deprecated.  Use traj_utils-srv:z instead.")
  (z m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <SetLocalPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:yaw-val is deprecated.  Use traj_utils-srv:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'vehicle_name-val :lambda-list '(m))
(cl:defmethod vehicle_name-val ((m <SetLocalPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:vehicle_name-val is deprecated.  Use traj_utils-srv:vehicle_name instead.")
  (vehicle_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetLocalPosition-request>)))
  ...
  "traj_utils/SetLocalPositionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetLocalPosition-request)))
  "Returns string type for a service object of type 'SetLocalPosition-request"
  "traj_utils/SetLocalPositionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetLocalPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLocalPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<SetLocalPosition-response> is deprecated: use traj_utils-srv:SetLocalPosition-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetLocalPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:success-val is deprecated.  Use traj_utils-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SetLocalPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:message-val is deprecated.  Use traj_utils-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetLocalPosition-response>)))
  ...
  "traj_utils/SetLocalPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetLocalPosition-response)))
  "Returns string type for a service object of type 'SetLocalPosition-response"
  "traj_utils/SetLocalPositionResponse")
