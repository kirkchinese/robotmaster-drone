...
(cl:defclass <CirclePoses> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (poses
    :reader poses
    :initarg :poses
    :type (cl:vector traj_utils-msg:Circle)
   :initform (cl:make-array 0 :element-type 'traj_utils-msg:Circle :initial-element (cl:make-instance 'traj_utils-msg:Circle))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CirclePoses>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CirclePoses)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-msg:<CirclePoses> is deprecated: use traj_utils-msg:CirclePoses instead.")))
...
(cl:defmethod poses-val ((m <CirclePoses>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-msg:poses-val is deprecated.  Use traj_utils-msg:poses instead.")
  (poses m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CirclePoses>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'poses)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'traj_utils-msg:Circle))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CirclePoses>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%Circle[] poses~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: traj_utils/Circle~%uint8 index~%geometry_msgs/Vector3 position~%float64 yaw~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CirclePoses)))
  "Returns full string definition for message of type 'CirclePoses"
  (cl:format cl:nil "std_msgs/Header header~%Circle[] poses~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: traj_utils/Circle~%uint8 index~%geometry_msgs/Vector3 position~%float64 yaw~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
