...
(cl:defmethod cl:initialize-instance :after ((m <Land-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Land-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<Land-request> is deprecated: use traj_utils-srv:Land-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Land-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Land-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<Land-response> is deprecated: use traj_utils-srv:Land-response instead.")))
