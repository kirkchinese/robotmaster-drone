...
(cl:defmethod cl:initialize-instance :after ((m <SetGPSPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGPSPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<SetGPSPosition-request> is deprecated: use traj_utils-srv:SetGPSPosition-request instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <SetGPSPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:latitude-val is deprecated.  Use traj_utils-srv:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <SetGPSPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:longitude-val is deprecated.  Use traj_utils-srv:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <SetGPSPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-srv:altitude-val is deprecated.  Use traj_utils-srv:altitude instead.")
  (altitude m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetGPSPosition-request>)))
  ...
  "traj_utils/SetGPSPositionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetGPSPosition-request)))
  "Returns string type for a service object of type 'SetGPSPosition-request"
  "traj_utils/SetGPSPositionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetGPSPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGPSPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<SetGPSPosition-response> is deprecated: use traj_utils-srv:SetGPSPosition-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetGPSPosition-response>)))
  ...
  "traj_utils/SetGPSPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetGPSPosition-response)))
  "Returns string type for a service object of type 'SetGPSPosition-response"
  "traj_utils/SetGPSPositionResponse")
