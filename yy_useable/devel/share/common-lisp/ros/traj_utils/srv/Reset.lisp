...
(cl:defmethod cl:initialize-instance :after ((m <Reset-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Reset-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<Reset-request> is deprecated: use traj_utils-srv:Reset-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Reset-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Reset-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<Reset-response> is deprecated: use traj_utils-srv:Reset-response instead.")))
