...
img_str_output = "/home/misaka/drone/keyboard_ctrl_ws/data/data_handmaker/output/"
img_str_output_source = "/home/misaka/drone/keyboard_ctrl_ws/data/data_handmaker/output_source/"

red_binary = "/home/misaka/drone/keyboard_ctrl_ws/data/data_handmaker/red_binary/"
yellow_binary = "/home/misaka/drone/keyboard_ctrl_ws/data/data_handmaker/yellow_binary/"

img_red_binary = glob.glob(red_binary + "*.png")
img_yellow_binary = glob.glob(yellow_binary + "*.png")

img_red = "/home/misaka/drone/keyboard_ctrl_ws/data/data_handmaker/red_re/"
img_yellow = "/home/misaka/drone/keyboard_ctrl_ws/data/data_handmaker/yellow_re/"

imgs_red = glob.glob(img_red + "*.png")
imgs_yellow = glob.glob(img_yellow + "*.png")

i= 0 
for img in imgs_red:
    img = cv2.imread(img)
    cv2.imshow("img",img)
    cv2.imwrite(img_str_output_source + f"circle{i}.png" ,img)
    cv2.waitKey(100)
    i+=1

for img in imgs_yellow:
    img = cv2.imread(img)
    cv2.imshow("img",img)
    cv2.imwrite(img_str_output_source + f"circle{i}.png" ,img)
    cv2.waitKey(100)
...
i = 0 
for img in img_red_binary:
    img = cv2.imread(img)
    cv2.imshow("img",img)
    cv2.imwrite(img_str_output + f"circle{i}.png" ,img)
    cv2.waitKey(100)
    i+=1

for img in img_yellow_binary:
    img = cv2.imread(img)
    cv2.imshow("img",img)
    cv2.imwrite(img_str_output + f"circle{i}.png" ,img)
    cv2.waitKey(100)
