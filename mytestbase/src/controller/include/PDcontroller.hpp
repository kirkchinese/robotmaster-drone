...
private:
    ...
    float m_Kdx = 0.1;
    float m_Kpx = 1.0;
    float m_Kix = 0.01; // Integral gain for x
    float m_last_e_x = 0;
    float m_integral_e_x = 0; // Integral error for x
    float m_Kdy = 0.1;
    float m_Kpy = 1.0;
    float m_Kiy = 0.01; // Integral gain for y
    float m_last_e_y = 0;
    float m_integral_e_y = 0; // Integral error for y
    float m_Kdz = 25.0;
    float m_Kpz = 2.0;
    float m_Kiz = 0.01; // Integral gain for z
    float m_last_e_z = 0;
    float m_integral_e_z = 0; // Integral error for z
    float m_Kdphi = 940; 
    float m_Kpphi = 17;
