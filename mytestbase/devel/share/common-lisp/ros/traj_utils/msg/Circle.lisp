...
(cl:defmethod cl:initialize-instance :after ((m <Circle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Circle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-msg:<Circle> is deprecated: use traj_utils-msg:Circle instead.")))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <Circle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-msg:index-val is deprecated.  Use traj_utils-msg:index instead.")
  (index m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Circle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_utils-msg:position-val is deprecated.  Use traj_utils-msg:position instead.")
  (position m))
