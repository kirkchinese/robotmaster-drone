...
(cl:defmethod cl:initialize-instance :after ((m <LandGroup-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LandGroup-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<LandGroup-request> is deprecated: use traj_utils-srv:LandGroup-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <LandGroup-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LandGroup-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<LandGroup-response> is deprecated: use traj_utils-srv:LandGroup-response instead.")))
