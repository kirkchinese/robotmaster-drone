...
(cl:defmethod cl:initialize-instance :after ((m <Takeoff-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Takeoff-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<Takeoff-request> is deprecated: use traj_utils-srv:Takeoff-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Takeoff-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Takeoff-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_utils-srv:<Takeoff-response> is deprecated: use traj_utils-srv:Takeoff-response instead.")))
